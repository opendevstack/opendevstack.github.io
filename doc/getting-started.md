...
![Application access menu](../assets/documentation/jira/jira-application-access-1.PNG)

There you will have to add the OpenDevStack groups according to the Jira user groups.

![Application access selection](../assets/documentation/jira/jira-application-access-2.PNG)

Click on the group selection and choose the group you want to add to Jira.

![Application access with added groups](../assets/documentation/jira/jira-application-access-3.PNG)
