= Local Installation Guide: Installation
:experimental:
...
== Prepare OpenDevStack environment in OpenShift

After the configuration of the Atlassian tools has been done, it's time to continue with the preparation of the OpenDevStack environment.
