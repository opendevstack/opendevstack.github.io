...
==== Templates (only required prior to 1.2.0)
...
in the `cd` namespace to create new images. Prior to 2.x, you should also start all builds in the `shared-services` namespace.
...
==== Rundeck (only required prior to 2.0)
...
The guide is still under construction, please see https://github.com/opendevstack/ods-documentation/issues/22 for details.
